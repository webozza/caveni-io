...
class Caveni_Io_Seo_Front
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_register_script($this->caveni_io . '-seo', CAVENI_IO_URL . '/public/js/caveni-seo.js', array('jquery'), $this->version, true);
        wp_localize_script(
            $this->caveni_io . '-seo',
            'caveniSeo',
            [
    ...
    public function display_marketing_data($attributes)
    {
        ...
        wp_enqueue_script($this->caveni_io . '-seo');

        ob_start();

        include_once CAVENI_IO_PATH . 'public/partials/marketing/seo.php';

        return ob_get_clean();
    }

    public function caveni_get_seo_data_callback()
    {
